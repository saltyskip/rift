...
#[openapi(
    ...
    paths(
        ...
        auth::sessions::routes::cli_start,
        auth::sessions::routes::cli_authorize,
        auth::oauth::routes::start,
        auth::oauth::routes::callback,
        auth::secret_keys::routes::verify_email,
        auth::secret_keys::routes::verify_email_confirm,
    ...
    components(schemas(
        ...
        crate::services::landing::models::ButtonStyle,
        crate::services::landing::models::ButtonFill,
        crate::services::landing::models::Elevation,
        ...
        auth::secret_keys::models::VerifyForm,
        ...
        auth::sessions::models::CliAuthorizeRequest,
        auth::sessions::models::CliAuthorizeResponse,
    ...
    tags(
        ...
        (name = "Tenant", description = "Tenant-level settings — landing-page branding"),
        ...
        utoipa::openapi::extensions::ExtensionsBuilder::new()
            .add(
                ...
                serde_json::json!([
                    ...
                    { "name": "Configuration", "tags": ["Domains", "Apps", "Tenant"] },
